...
export const CollegePortalView = ({ college: rawCollege, onBackToLanding, onOpenAdminLogin, onOpenPreceptorLogin, onOpenStudentLogin }) => {
  ...
  const logins = [
    ...
    },
    {
      ...
      roleBadge: 'Faculty & Evaluators',
      subtitle: 'Clinical Evaluators & Hospital Doctors',
      description: 'Dedicated evaluation login workspace for Hospital Doctors and College Pharmacology Evaluators to review student cases and practical records.',
      icon: Stethoscope,
    ...
    },
    {
      id: 'student',
      name: 'Student Login',
      roleBadge: 'Pharm.D & B.Pharm Candidate',
      subtitle: 'Pharm.D & B.Pharm Candidates & Interns (1st - 6th Year)',
      description: 'Comprehensive digital logbook login for PharmD students to document clinical cases, and B.Pharm students to document laboratory practicals.',
      icon: UserCheck,
